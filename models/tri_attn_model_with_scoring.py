...
class TriAttn(nn.Module):
	def __init__(self, args, loader):
		...
		self.modeling_layer_c = RecurrentContext(embed_size * 3, hidden_size)
	...
	def forward(self, query_embedded, batch_query_length,batch_query_mask,
		...
		context_input_modelling = torch.cat([query_aware_context_encoded, context_encoded,context_embedded], dim=-1)
	...
	def eval(self,query_embedded, batch_query_length,batch_query_mask,
		...
		query_aware_context_encoded, c2q_attention_matrix = self.attention_flow_c2q(query_embedded, context_embedded, batch_query_mask,
																 batch_context_mask)
		query_aware_context_encoded = self.dropout(query_aware_context_encoded)
