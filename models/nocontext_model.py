...
class NoContext(nn.Module):
    ...
    def forward(self, batch_query, bathc_query_embed, batch_query_length,
                                      batch_candidates_sorted, batch_candidates_embed_sorted,
                                      batch_candidate_lengths,
                                      batch_candidate_unsort, gold_answer_index, negative_indices, batch_len):
        ...
        answer_rep = batch_candidates_embed_sorted
